...
const sendMail = async (to, subject, text, html) => {
    try {
        // Corregido "transpoter" a "transporter"
        const info = await transporter.sendMail({
            from: '"Soporte Cinemark" <cinemark.soporte@gmail.com>',
            to,
            subject,
            text,
            html
        ...
        throw error; // Es buena práctica propagar el error
    }
};
    ...
    <body>
        <div class="container">
            <div class="header">
                <div class="logo">
                    ...
                    <svg width="100" height="60" viewBox="0 0 100 60" fill="none" xmlns="http://www.w3.org/2000/svg">
                        ...
                        <text x="50" y="35" text-anchor="middle" font-size="16" font-weight="bold" fill="#ffffff">CINEMARK</text>
                    </svg>
                </div>
            ...
            <div class="content">
                ...
                <p>Hemos recibido una solicitud para recuperar la contraseña de tu cuenta de CINEMARK. Para garantizar la seguridad de tu cuenta, necesitamos verificar que eres tú.</p>
            ...
            <div class="footer">
                <p>&copy; ${new Date().getFullYear()} CINEMARK. Todos los derechos reservados.</p>
                <p>Este es un correo electrónico automático, por favor no responda a este mensaje.</p>
                <div class="address">
                    CINEMARK S.A. de C.V. | Av. Principal #123, Col. Centro, Ciudad de México | RFC: ZGA123456ABC
                </div>
            </div>
        </div>
    </body>
